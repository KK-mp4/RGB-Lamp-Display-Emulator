import { getCurrentInstance, reactive, toRef, isRef, inject, defineComponent, computed, ref, h, resolveComponent, shallowRef, unref, watchEffect, markRaw, provide, Suspense, Transition, defineAsyncComponent, onErrorCaptured, useSSRContext, withCtx, createVNode, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./nuxt/index.b3663415.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./nuxt/error-component.07d4080b.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
const layouts = {
  default: defineAsyncComponent(() => import("./nuxt/default.fbee14e3.js").then((m) => m.default || m))
};
